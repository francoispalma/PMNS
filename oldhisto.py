...
#	with open("results_old/results128_old", "r") as f:
#		L = f.readlines()
#	LL = [int(elem[:-1]) for elem in L]
#	plt.hist(LL)
#	with open("results_old/results128_old2", "r") as f:
#		L = f.readlines()
#	LL = [int(elem[:-1]) for elem in L]
#	plt.hist(LL)
#	#plt.figure()
#	with open("results_old/results_old", "r") as f:
#		L = f.readlines()
...
#	plt.figure()
	with open("results_old/results64", "r") as f:
		L = f.readlines()
	...
	plt.figure()
	with open("results_old/results1024", "r") as f:
		L = f.readlines()
	LL = [eval(elem[:-1]) for elem in L]
	mini, maxi, meani = ([elem[0] for elem in LL], [elem[1] for elem in LL],
		[elem[2] for elem in LL])
	...
	plt.figure()
	with open("results_old/results128", "r") as f:
		L = f.readlines()
	LL = [eval(elem[:-1]) for elem in L]
	mini, maxi, meani = ([elem[0] for elem in LL], [elem[1] for elem in LL],
		[elem[2] for elem in LL])
	...
	plt.figure()
	with open("results_old/results204864", "r") as f:
		L = f.readlines()
	LL = [eval(elem[:-1]) for elem in L]
	mini, maxi, meani = ([elem[0] for elem in LL], [elem[1] for elem in LL],
		[elem[2] for elem in LL])
	...
	plt.figure()
	with open("results_old/results2048", "r") as f:
		L = f.readlines()
	LL = [eval(elem[:-1]) for elem in L]
	mini, maxi, meani = ([elem[0] for elem in LL], [elem[1] for elem in LL],
		[elem[2] for elem in LL])
	...
	plt.figure()
	with open("results_old/results2048128", "r") as f:
		L = f.readlines()
	LL = [eval(elem[:-1]) for elem in L]
	mini, maxi, meani = ([elem[0] for elem in LL], [elem[1] for elem in LL],
		[elem[2] for elem in LL])
...
#	plt.figure()
#	with open("results_old/results4096", "r") as f:
#		L = f.readlines()
#	LL = [eval(elem[:-1]) for elem in L]
#	mini, maxi, meani = ([elem[0] for elem in LL], [elem[1] for elem in LL],
#		[elem[2] for elem in LL])
...
#	plt.figure()
#	with open("results_old/results4096128", "r") as f:
#		L = f.readlines()
#	LL = [eval(elem[:-1]) for elem in L]
#	mini, maxi, meani = ([elem[0] for elem in LL], [elem[1] for elem in LL],
#		[elem[2] for elem in LL])
