...
{
	int64_t a0, a1, a2, a3, a4, b3, b4, b5, b6, b7, b8, b9, b10, b11;
	__int128 r0, r1, r2, r3, r4;
	int64_t v0p1_0, v0p1_1, v0p1_2, v0p1_3, m0m1_0, m0m1_1, m0m1_2, m0m1_3, m0m2_3, m0m2_4, m0m2_5, m0m2_6;
	__int128 t0_0, t0_1, t0_2, t0_3;
	...
	t0_0 = (__int128) v0p1_0 * b7 + (__int128) v0p1_1 * b6 + (__int128) v0p1_2 * b5 + (__int128) v0p1_3 * b4;
	t0_1 = (__int128) v0p1_0 * b8 + (__int128) v0p1_1 * b7 + (__int128) v0p1_2 * b6 + (__int128) v0p1_3 * b5;
	t0_2 = (__int128) v0p1_0 * b9 + (__int128) v0p1_1 * b8 + (__int128) v0p1_2 * b7 + (__int128) v0p1_3 * b6;
	t0_3 = (__int128) v0p1_0 * b10 + (__int128) v0p1_1 * b9 + (__int128) v0p1_2 * b8 + (__int128) v0p1_3 * b7;
	
	r0 = t0_0 - ((__int128) a4 * m0m2_3);
	r1 = t0_1 - ((__int128) a4 * m0m2_4);
	r2 = t0_2 - ((__int128) a4 * m0m2_5);
	r3 = t0_3 - ((__int128) a4 * m0m2_6);
	r4 = t0_0 - ((__int128) a0 * m0m1_3 + (__int128) a1 * m0m1_2 + (__int128) a2 * m0m1_1 + (__int128) a3 * m0m1_0);
