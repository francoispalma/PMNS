...
const _poly G1 = { .deg = 4,
		.t = (int64_t[]) {0, 0, 0, 0x200000000000} },
	G2 = { .deg = 5,
		.t = (int64_t[]) {0xcd73565390388481, 0x3913c213bac0519a, 0xd08f7ada91d393e2, 0x72b8686becf02f43, 0xcf91} },
	G3 = { .deg = 2,
		.t = (int64_t[]) {0, 0x80000000000000} },
	G4 = { .deg = 5,
		.t = (int64_t[]) {0xbd73565390388481, 0x3913c213bac0519a, 0xd0937ada91d393e2, 0x72b8686becf02f43, 0xcf91} };
_poly	__P__ = { .deg = 5, .t = (int64_t[]) {0xcd73565390388481, 0x3913c213bac0519a, 0xd0937ada91d393e2, 0x72b8686becf02f43, 0xcf91} },
	Gi[] = {G1, G2, G3, G4};
